...
Your Rhai scripts can hook into any combination of the above services. They can modify the request, response, and/or related metadata as they're passed along.
